...
, base = file(".")).aggregate(scala_protobuf,akka_tcp_server,akka_tcp_client,akka_sample,akka_http,akka_cluster)
...
lazy val akka_cluster = Project(id = "akka_cluster" , base = file("akka_cluster")).enablePlugins()